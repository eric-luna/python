...
str = c.formatmonth(2017,7,0)
print(str)

#create an HTML formatted calendar
hc = calendar.HTMLCalendar(calendar.SUNDAY)
str2 = hc.formatmonth(2017,7)
print(str2)

#loop over the days of the month 
#zeroes mean that the day of the week is an overlapping month
for i in c.itermonthdays(2017,7):
	print(i)

#The calendar module provides useful utilities for the given locale
#such as the name of days and months in both full and abbreviated forms
